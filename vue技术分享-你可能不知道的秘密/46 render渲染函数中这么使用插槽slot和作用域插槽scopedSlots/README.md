...
var childNode = {
  ...
  render: function (createElement) {
    return createElement(
      ...
      [this.$scopedSlots.child_scope_slot(), createElement('ul', [createElement('li', ['列表组件1']), createElement('li', ['列表组件2'])])]
    )
  }
}
...
var parentNode = {
  ...
  render: function (createElement) {
    return createElement(
      ...
      }, []), this.$scopedSlots.scope_slot(10), this.$slots.normal_name_slot, this.$slots.default])
  }
}
